...
This dependency-free suite exercises the Podcast2 4.0.1 remediation against an existing Grav 2 installation. It uses Grav's own Composer autoloader, Page implementation, getID3 plugin, Feed plugin, Twig runtime, and PHP development server; it does not install or contact external services.
...
- remote URL, IP-address, redirect, protocol, timeout, and DNS-pinning policy;
